 ...
 *
 */
public class ArrayUtils { private ArrayUtils() {
     ...
     * </p>
     * <pre class="code">
     * StringUtils.addStringToArray(new String[]{"index"},"world"); //--- [index,world]
     ...
     * </p>
     * <pre class="code">
     * StringUtils.sortStringArray(new String[]{"index","boy","amazing"}); //--- [amazing,boy,index]
     * </pre>
     *
     * @param array 数组
     * @return 排序后的字符串数组
