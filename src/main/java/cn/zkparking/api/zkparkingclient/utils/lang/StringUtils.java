...
/**
 * description: StringUtils工具类主要提供了针对字符串，字符串数组常用的工具类方法
 *
 */
public class StringUtils {
    ...
    /**
     * 判断字符串是否为{@code null}或空字符串,判断字符串是否为空
     *
     * @param str 字符串
    ...
    /**
     * 判断对象是否为{@code null}或空字符串,判断对象是否为空
     *
     * @param obj 对象
     * @return 如果对象是{@code null}或空字符串则返回{@code true}，否则返回{@code false}
     */
    ...
    /**
     * 判断对象是否不为{@code null}或空字符串,判断对象是否不为空
     *
     * @param obj 对象
     * @return 如果对象是{@code null}或空字符串则返回{@code false}，否则返回{@code true}
     */
    ...
    /**
     * 判断字符串是不为{@code null}或空字符串,判断字符串不为空
     *
     * @param str 字符串
     * @return 如果字符串是{@code}或空字符串则返回{@code false}，否则返回{@code true}
     */
     ...
     * </p>
     * <pre class="code">
     * StringUtils.delete("index world","l"); //--- "heo word";
     * </pre>
     *
     * @param str     字符串
     ...
     * </p>
     * <pre class="code">
     * StringUtils.unCapitalize("Hello"); //--- "index"
     * </pre>
     *
     * @param str 字符串
    ...
    private static Pattern p = Pattern.compile("^((13[0-9])|(15[0-9])|(18[0-9])|(17[0-9]))\\d{8}");
